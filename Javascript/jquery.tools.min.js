...
" or greater is required</h2><h3>" + (g[0] > 0 ? "Your version is " + g : "You have no flash plugin installed") + "</h3>" + (a.tagName == "A" ? "<p>Click here to download latest version</p>" : "<p>Download latest version from <a href='" + k + "'>here</a></p>"); if (a.tagName == "A") a.onclick = function() { location.href = k } 
        ...
        } var i = document.all, k = "https://web.archive.org/web/20110805224510/http://www.adobe.com/go/getflashplayer", n = typeof jQuery == "function", o = /(\d+)[^\d]+(\d+)[^\d]*(\d*)/, j = { width: "100%", height: "100%", id: "_" + ("" + Math.random()).slice(9), allowfullscreen: true, allowscriptaccess: "always", quality: "high", version: [3, 0], onFail: null, expressInstall: null, w3c: false, cachebusting: false }; window.attachEvent && window.attachEvent("onbeforeunload", function() { __flash_unloadHandler = function() { }; __flash_savedUnloadHandler = function() { } });
...
/*
     FILE ARCHIVED ON 22:45:10 Aug 05, 2011 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 04:45:16 Nov 14, 2025.
...
playback timings (ms):
  ...
  esindex: 0.008
  cdx.remote: 15.606
  LoadShardBlock: 125.085 (3)
  PetaboxLoader3.datanode: 95.234 (4)
  load_resource: 278.622
  PetaboxLoader3.resolve: 201.955
*/